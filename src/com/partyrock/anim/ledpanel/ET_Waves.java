 ...
 * 
 */
public class ET_Waves extends ElementAnimation {
    ...
    public ET_Waves(LightMaster master, int startTime, ArrayList<ElementController> elementList, double duration) {
    ...
    */
    ...
    public void increment(double percentage) {
        ...
        for (ElementController controller : getElements()) {
            ...
            // How many rows should be on based on our percentage and 60% additional time for wave animation 
            int rowsOn = (int) (percentage * panel.getPanelHeight()*1.6);
    	                ...
    	                for (int r1 = 0; r1 < panel.getPanelHeight(); r1++) {
                            ...
                            // Set the color to the color we picked when making the animation
                		 		...
                		 		System.out.println("r " + r1 + "  height: " + (int)(1*Math.cos(waveAngle))+ " ");
             		 			if(r1 <= (int)(1*Math.sin(waveAngle + (rowsOn)) +7)){
